...
//    @Value("${bankServiceUrl}")
    private static String url = "http://localhost:8100/api/v1";
    ...
    public ResponseEntity<AuthenticationResponse> login(AuthMethod method, AuthenticationRequest authRequest) {
